...
@section('titulo') Editando Professor @endsection
        ...
        <div class="row">
            <div class="col" >
                <div class="form-check form-check-inline">
                    <input class="btn-check" type="radio" name="status" id="ativo" value="1" @if ($dados->status == '1') checked @endif>
                    <label class="btn btn-outline-success" for="ativo">ATIVO</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="btn-check" type="radio" name="status" id="inativo" value="0" @if ($dados->status == '0') checked @endif>
