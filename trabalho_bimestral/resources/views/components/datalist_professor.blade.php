<div class="row">
    ...
    <div class="col d-flex justify-content-end">
        <a href="{{ route('professores.create') }}" class="btn btn-primary btn-create">
            <caption>Adicionar Professor</b></caption>
            ...
            <tbody>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td class="d-none d-md-table-cell">@if ($item->status == 1) ATIVO @else INATIVO @endif</td>
                        <td>
