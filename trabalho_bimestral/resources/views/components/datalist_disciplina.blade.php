<div class="row">
    ...
    <div class="col d-flex justify-content-end">
        <a href="{{ route('disciplinas.create') }}" class="btn btn-primary btn-create">
            <caption>Adicionar Disciplina</b></caption>
...
<div class="row">
    <div class="col">
        <table class="table align-middle caption-top  table table-striped">
            <caption>Tabela de <b>Disciplina</b></caption>
            <thead>
                ...
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a nohref style="cursor:pointer" onclick="showInfoModal('NOME: {{ $item->nome }}', 'Curso: {{ $item->curso->nome }}', 'Carga Horária: {{ $item->carga }}')" class="btn btn-primary">
