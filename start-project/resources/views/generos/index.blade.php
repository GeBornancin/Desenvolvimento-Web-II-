...
<div>
    ...
    <table class="table align-middle caption-top table-striped">
        ...
        <caption>Tabela de <b>Generos</b></caption>
   
        @if(UserPermissions::isAuthorized('generos.create'))
        <a href="{{route('generos.create')}}" class="btn btn-success btn-block align-content-center">Gênero</a>
        @endif
            ...
            @foreach ($data as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <a href= "{{ route('generos.edit', $item->id) }}" class="btn btn-success">
                    ...
                    <form action="{{ route('generos.destroy', $item['id']) }}" method="POST" id="form_{{$item['id']}}">
                        @csrf
                        @method('DELETE')
                    </form>
                </tr>
