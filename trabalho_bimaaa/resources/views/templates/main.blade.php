                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown ps-2">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#">
                                ...
                                <span class="ps-1  me-md-10  text-white">Capacitações</span>
                            </a>
                            <ul class="dropdown-menu  bg-white bg-gradient ">
                                <li><a href="{{route('eixos.index')}}" class="dropdown-item text-success  ">Eixos/Áreas</a></li>
                                <li><a href="{{route('cursos.index')}}" class="dropdown-item text-success">Cursos</a></li>
                                <li><a href="#" class="dropdown-item text-success">Disciplinas</a></li>
                            </ul>
                        </li>
