...
@section('titulo') Editando Curso @endsection

@section('conteudo')

    <form action="{{ route('cursos.store', $dados->id) }}" method="POST">
        @csrf
        <div class="row">
            <div class="col" >
        ...
        <div class="row">
            <div class="col" >
                <div class="form-floating mb-3">
                    <select name="id_eixo" class="form-control">
                        @foreach($eixos as $e)
                            <option value="{{$e->id}}">
                                {{$e->nome}}
                            </option>
                    ...
                    <label for="id_eixo">Eixo / Área</label>
                </div>
            </div>
        </div>
        <div class="row">
