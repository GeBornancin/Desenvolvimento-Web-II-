<div class="row">
    ...
    <div class="col d-flex justify-content-end">
        <a href="{{ route('cursos.create') }}" class="btn btn-primary btn-create">
            <caption>Adicionar Curso</b></caption>
            ...
            @foreach ($data as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <a nohref style="cursor:pointer" onclick="showInfoModal('NOME: {{ $item->nome }}', 'SIGLA: {{ $item->sigla }}', 'TEMPO: {{ $item->tempo }}', 'EIXO: ')" class="btn btn-primary">
